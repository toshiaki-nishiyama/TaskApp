...
{
    // メンバ変数
    private int mYear, mMonth, mDay, mHour, mMinute;        // タスクの日時を保持する
    private Button mDateButton;                                // 日付を設定する
    private Button mTimeButton;                                // 時刻を設定する
    private EditText mTitleEdit;                               // タイトルを入力する
    private EditText mContentEdit;                             // 内容を入力する
    private EditText mCategoryEdit;                            // カテゴリを入力する
    private Task mTask;                                         // タスク
    ...
    private void addTask() {
        ...
        realm.beginTransaction();               // データを追加、削除など変更を行う場合
        realm.copyToRealmOrUpdate(mTask);      // データの保存・更新
        realm.commitTransaction();              // コミット
